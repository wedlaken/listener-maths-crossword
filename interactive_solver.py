            ...
            const content = `
                <div style="background: rgba(255,255,255,0.1);padding: 20px;border-radius: 15px;margin: 20px 0;backdrop-filter: blur(10px);">
                    ...
                    <div style="background: rgba(255,255,255,0.2);padding: 15px;border-radius: 10px;border-left: 4px solid #ffd700;text-align: left;font-style: italic;">
                        ...
                        • <strong>Clued entries</strong> in "a:b" format - find prime factors where no. of factors = a and difference between largest and smallest factor = b<br>
                        • <strong>Unclued entries</strong> (marked "Unclued") will form an anagram of themselves when multiplied by an integer<br>
            ...
            const content = `
                ...
                <div style="background: rgba(255,255,255,0.1);padding: 20px;border-radius: 15px;margin: 20px 0;backdrop-filter: blur(10px);">
                    ...
                    <p style="margin: 0 0 15px 0; line-height: 1.6;">
                        ...
                        you've demonstrated great tenacity and problem-solving skills.
                    </p>
