...
<body>
    ...
    <script>
            ...
            const content = `
                <div style="background: rgba(255,255,255,0.1);padding: 20px;border-radius: 15px;margin: 20px 0;backdrop-filter: blur(10px);">
                    ...
                    <div style="background: rgba(255,255,255,0.2);padding: 15px;border-radius: 10px;border-left: 4px solid #ffd700;text-align: left;font-style: italic;">
                        ...
                        • <strong>Clued entries</strong> show "b:c" format - find numbers where the sum of digits = b and the product of digits = c<br>
                        • <strong>Unclued entries</strong> (marked "Unclued") require you to find valid solutions that don't conflict with crossing clues<br>
                        • <strong>Mathematical Key:</strong> Look for patterns in the unclued entries - there's a special cyclic number that holds the key to solving the entire puzzle!
                    </div>
                </div>
                <div style="background: rgba(255,255,255,0.1);padding: 20px;border-radius: 15px;margin: 20px 0;backdrop-filter: blur(10px);">
                    ...
                    <ul style="text-align: left; margin: 0; padding-left: 20px;">
                        ...
                        <li>Don't be afraid to use the undo feature if you make mistakes</li>
                    </ul>
                </div>
            `;
            const buttons = `
                <button onclick="hideModal('intro-modal')" style="background: linear-gradient(45deg, #ff6b6b, #4ecdc4);color: white;border: none;padding: 15px 30px;border-radius: 25px;font-size: 1.2em;font-weight: bold;cursor: pointer;transition: transform 0.2s;box-shadow: 0 5px 15px rgba(0,0,0,0.2);" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">🚀 Start Solving!</button>
            `;
        ...
        function showAnagramCompletionCelebration() {{
            ...
            const content = `
                <div style="background: rgba(255,255,255,0.1);padding: 20px;border-radius: 15px;margin: 20px 0;backdrop-filter: blur(10px);">
                    <h3 style="margin: 0 0 15px 0; color: #ffd700;">Incredible Achievement!</h3>
                    <p style="margin: 0 0 15px 0; line-height: 1.6;">
                        You have successfully completed both stages of this extraordinary mathematical puzzle! 
                        This is no small feat - you've demonstrated exceptional mathematical insight and perseverance.
                    </p>
                </div>
                <div style="background: rgba(255,255,255,0.1);padding: 20px;border-radius: 15px;margin: 20px 0;backdrop-filter: blur(10px);">
                    <h3 style="margin: 0 0 15px 0; color: #ffd700;">The Mathematical Key Revealed</h3>
                    <p style="margin: 0 0 15px 0; line-height: 1.6;">
                        Did you discover the special cyclic number <strong>142857</strong>? This remarkable number holds the key to the entire puzzle:
                    </p>
                    <div style="background: rgba(255,255,255,0.2);padding: 15px;border-radius: 10px;border-left: 4px solid #ffd700;text-align: left;font-style: italic;">
                        <strong>The Magic of 142857:</strong><br>
                        • 142857 × 1 = 142857<br>
                        • 142857 × 2 = 285714 (anagram!)<br>
                        • 142857 × 3 = 428571 (anagram!)<br>
                        • 142857 × 4 = 571428 (anagram!)<br>
                        • 142857 × 5 = 714285 (anagram!)<br>
                        • 142857 × 6 = 857142 (anagram!)<br>
                        <br>
                        This cyclic property makes it the perfect key for both the initial puzzle and the anagram challenge!
                    </div>
                </div>
                <div style="background: rgba(255,255,255,0.1);padding: 20px;border-radius: 15px;margin: 20px 0;backdrop-filter: blur(10px);">
                    ...
                    <p style="margin: 0 0 15px 0; line-height: 1.6;">
                        ...
                        you've demonstrated the tenacity and problem-solving skills that make a true puzzle master.
                    </p>
                    <p style="margin: 0 0 15px 0; line-height: 1.6; font-style: italic;">
                        "The best puzzles are those that teach us something about mathematics, about ourselves, 
                        and about the joy of discovery." - You've just experienced that joy!
                    </p>
                </div>
            `;
            const buttons = `
                <button onclick="hideModal('anagram-completion-celebration')" style="background: linear-gradient(45deg, #ff6b6b, #4ecdc4);color: white;border: none;padding: 15px 30px;border-radius: 25px;font-size: 1.2em;font-weight: bold;cursor: pointer;transition: transform 0.2s;box-shadow: 0 5px 15px rgba(0,0,0,0.2);" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">🎉 Celebrate Victory! 🎉</button>
            `;
